...
&emsp;&emsp;使用[脚本](getdatafromweb.py)将本草纲目中关于药材的释名、气味和主治抓取下来，作为数据使用。

&emsp;&emsp;温馨提醒：千万别抓的太快，否则会被墙，别问我为什么知道。

&emsp;&emsp;从网上抓下来的数据功效和药方是写在一起的，因此还需要经过将药方提炼出来，只保留主治的症状在功效描述里（由于功效描述大部分是格式固定的，因此可以使用re将其分离出来，分离可参考此脚本）
